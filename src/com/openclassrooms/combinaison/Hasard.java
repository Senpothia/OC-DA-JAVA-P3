...
public class Hasard {
	...
	/**
	 * Retourne un nombre entier inférieur à 10 et supérieur à un entier founi en
	 * paramètre
	 * 
	 * @param val Valeur entière indiquant la valeur mininmum du digit demandée
	...
	public int moins(int val) {
		...
		// System.out.println("Une valeur infï¿½rieure ï¿½ " + val + ":" + hasard);
		return hasard;

	}

	/**
	 * Fourni un tableau d'entier compris entre 0 et 9 inclus. La taille du tableau
	 * est définie par l'entier passé en paramètre
	 * 
	 * @param nbDigit Nombre de digit contenus dans la combinaison requise
	 * @return Un tableau de int contenant les digits de la combinaison tirée
	 *         aléatoirement
	 */
