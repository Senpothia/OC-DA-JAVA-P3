...
/**
 * Définit un objet lecteur pour la saisie et le traitement des informations entrées au clavier par l'utilisateur
 * 
 * @author Michel Lopez
 * @version 1.0
 *
...
public class Lecteur {
	 ...
	 * @param nbChiffres
	 * 					Nombre de caractères à saisir au clavier
	 * @return La combinaison saisie au clavier par l'utilsateur ou un code associé
	...
	public int lecture(int nbChiffres) {
		...
		do {
			...
			catch (java.lang.NumberFormatException e) { if (nbChiffres > 0) { // Erreur de saisie sur un nombre entier attendu. La saisie n'est pas
	 ...
	 * Gère la saisie au clavier d'un nombre entier attendu
 	 * @param nbChiffres
	 * 			Nombre de caractère entiers attendus dans la saisie au clavier
	 ...
	 * 
	 * @param combinaison
	 * 					Combinaison à décomposer
	 * @param nbDigit
	 * 					Taille de la combinaison à décomposer
